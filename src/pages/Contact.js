        ...
        <div className="container">
            ...
            <div className="col-md-6">
                ...
                {/* <address>
                    ...
                    <img alt="Img" src="/icon-marker.png" className="icon" />
                    </div>
                    <p><strong>Company name INC.</strong> <br />532 Avenue Street, Omaha</p>
                </address>
                <a href="#" className="phone"><span className="contact-icon"><img alt="Img" src="/icon-phone.png" className="icon" /></span> +1 800 931 033</a>
                <a href="#" className="email"><span className="contact-icon"><img alt="Img" src="/icon-envelope.png" className="icon" /></span> contact@companyname.com</a> */}
                </div>
            </div>
